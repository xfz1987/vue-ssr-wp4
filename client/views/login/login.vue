<template>
    ...
    <input type="password" class="login-input" placeholder="Password" autocomplete="new-password" v-model="password">
  ...
  methods: {
    ...
    validate () {
      if (!this.username.trim()) {
        this.errorMsg = 'username can not empty'
        return false
      }
      if (!this.password.trim()) {
        this.errorMsg = 'password can not empty'
        return false
      }
      this.errorMsg = ''
      return true
